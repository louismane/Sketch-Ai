...
const MEDIUM_CONSTRAINTS: Record<string, string> = {
    ...
    [ArtMedium.MECHANICAL_PENCIL]: "Focus on precision, consistent line weight, and fine cross-hatching. Emphasize not needing to sharpen and maintaining sharp detail.",
    [ArtMedium.CHALK]: "Focus on broad strokes, blending with cloth or fingers, and the dusty, impermanent nature of the medium. Contrast with paper color.",
    [ArtMedium.WATER_BASED_MARKER]: "Focus on layering without tearing the paper, using water to blend, and the transparent nature of the ink.",
    [ArtMedium.VECTOR_ART]: "Focus on anchor points, bezier curves, stroke versus fill, and non-destructive geometric construction.",
    [ArtMedium.PIXEL_ART]: "Focus on resolution constraints, dither patterns, limited color palettes, and single-pixel precision.",
    [ArtMedium.CARTOON]: "Focus on exaggeration, line weight variation, simplified forms, and expressive character dynamics.",
    [ArtMedium.ANIME_MANGA]: "Focus on 'big eyes, small mouth' proportions, dynamic speed lines, cel shading, and iconic hair silhouettes.",
    [ArtMedium.GESTURE_STUDY]: "Focus on the 'line of action', rhythmic flow, capturing movement in seconds, and avoiding detail.",
    [ArtMedium.CONSTRUCTION_STUDY]: "Focus on 3D primitives (spheres, boxes, cylinders), skeletal structure, and the 'mannequinization' of form.",
    [ArtMedium.PERSPECTIVE_STUDY]: "Focus on vanishing points, horizon lines, foreshortening, and accurate spatial depth. Use 1, 2, or 3 point logic.",
    [ArtMedium.VALUE_STUDY]: "Focus on the 5-tone scale (highlight, midtone, core shadow, reflected light, cast shadow). Ignore local color.",
    [ArtMedium.LIGHTING_STUDY]: "Focus on light source direction, hard versus soft edges, and how light defines 3D volume.",
    [ArtMedium.COMIC_BOOK]: "Focus on paneling, gutters, dynamic spotting of blacks, and bold ink outlines.",
    [ArtMedium.STORYBOARD]: "Focus on camera angles, shot composition (wide, medium, close-up), and narrative flow through sequential beats.",
    [ArtMedium.CONCEPT_ART]: "Focus on 'silhouette first', iterative design, world-building elements, and functional aesthetics.",
    [ArtMedium.CHARACTER_DESIGN]: "Focus on personality through shape language, costume hierarchy, and turnaround consistency.",
